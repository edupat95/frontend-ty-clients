...
const getBarman = () => {
  const barmanSession = localStorage.getItem('barman');
  //console.log("Datos public utilities de barman" + barmanSession)
  const barmanObjeto: Worker = JSON.parse(barmanSession ? barmanSession : "{}");
  return barmanObjeto;
}

export { getSession , getWorker, getCashier, getRecorder, getBarman};